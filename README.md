...
本插件原名为 **FuckDalamudCN**。此前，由 OtterCorp 维护的 Dalamud CN 分支引入了与上游不一致的代码，包括禁用部分插件以及采集用户信息[EventTracking.cs#L54-L69](https://github.com/ottercorp/Dalamud/blob/fd4b1fbad65d495e75d4b306b33c613e2ee01038/Dalamud/Support/EventTracking.cs#L54-L69)。
...
FastDalamudCN provides acceleration services for loading and downloading Dalamud 3rd-party repositories (Github) and offers translated descriptions for main repository plugins to enhance the user experience.
